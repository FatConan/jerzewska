...
export default class Galleria extends BaseClass{
    constructor(){
        super();
        this.index = 0;
    ...
    addEvents(){
        this.eventHandler.addListener(".galleria-nav div", (e, args) => {
            e.preventDefault();
    ...
    async showSpecific(index, withPush){
        ...
        await this.transition(this.shots, function(el){
        ...
        if($el.length){
            $el.addClass("showing");
            this.transition($el, function(el){
